...
const API_APP_KEY2 = "&apiKey=" + process.env.API_KEY5; // API keys for Spoonacular; limited to 150 points a day.
const API_APP_KEY4 = "&apiKey=" + process.env.API_KEY5; // second API key to not overload the first one with hits.
